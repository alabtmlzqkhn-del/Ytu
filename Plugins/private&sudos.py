    ...
    if text == '/start' and not dev_pls(m.from_user.id, m.chat.id):
        ...
        if bot_photo_file_id:
            m.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton('fadi', url=f't.me/fvamv', style="primary")],
                    [
                        InlineKeyboardButton('- المطور', url=f't.me/fvamv', style="primary"),
                        InlineKeyboardButton(
                            '- اضفني',
                    ...
                    [InlineKeyboardButton('- لشراء بوت مشابه', url='https://t.me/fvamv', style="danger")]
                ])
            )
        else:
        ...
        return m.reply(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton('source fadi', url='https://t.me/fvamv', style="primary")
                    ]
                ]
            )
        )
...
''',
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("source fadi", url=f't.me/{channel}', style="primary")]]
            )
        )
